...
path_export = r'C:\Users\anderson.visconti\Desktop\export\2016092400'
path_shape = r'D:\Middle Office\Middle\Hidrologia\ShapeFiles\Rio_Parana'
nome_arquivo = r'prate.01.2016092400.daily.nc'                         # nome do arquivo
...
range_data = ['2016-10-29', '2016-11-05']  # range de datas para somatorio da preciptacao - limite inferior e <
range_escala = {'inf': 0,
                'sup': 500,
                'step': 10
...
full_path = os.path.join(path_file, nome_arquivo)
full_path_normais = os.path.join(path_file, nome_arquivo_normais)
file = Dataset(full_path, mode='r')                                                     # abre arquivo netcdf
